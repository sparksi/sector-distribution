...
class SubThemeGenerator {
   ...
   *
   * @param string $dir
   *   Directory where a sector starter kit already copied to.
   *
   * @return $this
   */
  ...
  protected function getFileContentReplacementPairs(): array {
    return [
      'SECTOR_SUBTHEME_NAME' => $this->getName(),
      'SECTOR_SUBTHEME_DESCRIPTION' => $this->getDescription(),
      'SECTOR_SUBTHEME_MACHINE_NAME' => $this->getMachineName(),
      "\nhidden: true\n" => "\n",
    ];
  }
